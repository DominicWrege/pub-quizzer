...
if config_env() == :prod do
  ...
  # Persistent, writable directory for user-uploaded images. The release's
  # priv/static is read-only (Nix store), so uploads must live elsewhere and
  # are served by PubQuizzerWeb.UploadController rather than Plug.Static.
  config :pub_quizzer, :upload_dir, System.get_env("UPLOAD_DIR", "/var/lib/pub-quizzer/uploads")
